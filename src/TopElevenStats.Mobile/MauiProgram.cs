...
namespace TopElevenStats.Mobile;
...
public static class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        using var stream = assembly.GetManifestResourceStream("TopElevenStats.Mobile.appsettings.json");
        ...
        builder.Services.AddDbContextFactory<AppDbContextGames>(opt =>
        {
